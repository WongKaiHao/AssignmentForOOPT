        ...
        do {
            ...
            if (Character.toUpperCase(confirm) == 'Y') {
                ...
                if (Character.toUpperCase(confirm) == 'Y') {
                    ...
                    Product products = new Product(prodId, prodName, quantity, unitprice);
            ...
            if (productID.matches(product.get(i).getProductID())) {
                do {
                    ...
                    if (choose == 1) {
                        ...
                        sure = input.next().charAt(0);
                        if (Character.toUpperCase(sure) == 'Y') {
                            product.get(i).setUnitPrice(unitprice);
        ...
        do {
            ...
            if (inputs) {
                ...
                if (Character.toUpperCase(entry) == 'Y') {
                    for (i = 0; i < product.size(); i++) {
                        if (id.equals(product.get(i).getProductID())) {
                            subTotal += quan * product.get(i).getUnitPrice();
                            quanti.set(i, quan + quanti.get(i));//report used
                            quan1.set(i, quan);//each order used
                            int num = product.get(i).getQuantity() - quan;
        ...
        do {
            ...
            try {
                ...
                if ((cash - total) >= 0) {
                    ...
                    sCount++;
                    for (int i = 0; i < sys.getCashierList().size(); i++) {
                        if (cashier.equals(sys.getCashierList().get(i))) {
